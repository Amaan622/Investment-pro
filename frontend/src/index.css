@import url('[fonts.googleapis.com](https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=JetBrains+Mono:wght@400;500;600&display=swap)');

:root {
  /* Premium Dark Theme */
  --bg: #08090d;
  --bg-subtle: #0c0e14;
  --bg-card: linear-gradient(145deg, rgba(18, 22, 35, 0.9), rgba(12, 15, 24, 0.95));
  --bg-card-solid: #12162a;
  --bg-card-hover: rgba(30, 38, 60, 0.8);
  --bg-glass: rgba(15, 18, 30, 0.6);
  ...
  --gradient-accent-subtle: linear-gradient(135deg, rgba(139, 92, 246, 0.1) 0%, rgba(6, 182, 212, 0.1) 100%);
  --gradient-shine: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0) 50%);
...
body::before {
  ...
  background: 
    ...
    radial-gradient(ellipse 50% 30% at 0% 100%, rgba(139, 92, 246, 0.05), transparent);
  pointer-events: none;
  z-index: -1;
}
...
.level-stat-pill:hover {
  background: color-mix(in srgb, var(--lc) 12%, transparent);
  transform: translateY(-1px);
}

.level-stat-pill strong {
  color: var(--lc);
  font-weight: 700;
}

.level-stat-pill span {
  color: var(--text-secondary);
}
